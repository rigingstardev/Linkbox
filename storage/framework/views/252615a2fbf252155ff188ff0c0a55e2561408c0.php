            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
               <div  class="pdng-10-15">
                  ...
                  <div class="col-md-9 custom_error">
                     <?php echo Form::text('phone', '', ['class' => 'form-control autoComplete send-as-text send-qs mrgn-btm-25','placeholder' => 'Contact Number','data-suggest'=>'patientPhone','maxlength'=>15,'disabled'=>"",'id'=>'phone']); ?>
