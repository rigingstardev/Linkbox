<div class="col-sm-3 pdng-0">
   ...
   <!--  <label for="inlineRadio1" class="datepicker-control"> -->       
        <!-- <div class="input-group datetimepicker">
            <input type="text" class="date-picker form-control" value="<?php echo $CurAnswer[$qSets->id][$qSets->category_id]; ?>" name="answer[<?php echo $qSets->id; ?>][<?php echo $qSets->category_id; ?>]">
        ...
        <div class="input-group datepicker-control date form_date" data-date="" data-date-format="mm/dd/yyyy">
            <input class="form-control <?php echo $clinicalCls; ?>" onClick="this.blur()" type="text" value="<?php echo $CurAnswer[$qSets->id][$qSets->category_id]; ?>" name="answer[<?php echo $qSets->id; ?>][<?php echo $qSets->category_id; ?>]" readonly>            
