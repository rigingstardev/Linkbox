...
<!-- <script src="{{asset('assets/physician/js/jquery-2.1.1.min.js')}}"></script> -->
<script src="{{asset('assets/physician/js/bootstrap.min.js')}}"></script>
<script src="{{asset('assets/physician/js/moment-with-locales.js')}}"></script>
...
<script type="text/javascript" src="{{asset('assets/common/js/user-validate.js')}}"></script>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" id="redirect-csrf-roken" value="{{ csrf_token() }}">
