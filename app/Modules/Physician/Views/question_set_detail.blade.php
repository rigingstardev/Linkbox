               ...
               <div class="content-sub mrgn-btm-20 pdng-0">
                  ...
                  <div class="content-area-sub">
                    ...
                    <!-- <label class="sponsored mrgn-btm-25"><i class="fa fa-star" aria-hidden="true"></i> Sponsored</label>-->
                        ...
                        <button type="button" class="btn btn-third btn-block"  onclick="location.href ='{{url('physician/questionSetPreview/'.Hashids::encode($qid).'/edit')}}'">View Question Set</button>
                        @endif
                     </div>
                  </div>
               </div>
