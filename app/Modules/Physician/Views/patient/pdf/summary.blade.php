...
<html style="{{$style['html']}}">
    ...
    <body style="{{ $style['body'] }}">        
        ...
        <table  style="{{ $style['table'].$style['table.block1']  }}">
            <tr>
                <td style="{{ $style['table.block1.td']}}">Patient Name</td><td>{!!$summaryDet['patient']['first_name']!!} {!!$summaryDet['patient']['last_name']!!}</td>
            </tr>
            <tr>
                <td style="{{ $style['table.block1.td']}}">Gender</td><td>@if($summaryDet['patient']['gender'] == 'F' ) {{'Female'}} @else{{'Male'}} @endif</td>
            </tr>
            <tr>
                <td style="{{ $style['table.block1.td']}}">Chief Complaint</td><td>{!! ucwords($summaryDet['question']['title']) !!}</td>
            </tr>
            <tr>
                <td style="{{ $style['table.block1.td']}}">Physician Name</td><td>{!!$summaryDet['physician']['name']!!}</td>
            </tr>
            <tr>
        ...
        <table  style="{{ $style['table'].$style['table.block2']}}">
            <tr>
                <td><h3 style="{{$style['table.h3']}}">Summary Report</h3></td>
            </tr>
            <tr>
                <td>{{$summary}}</td>
            </tr>
