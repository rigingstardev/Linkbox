...
<div class="content-wrapper">
    ...
    <section class="content content-library">
        ...
        <div class="content-sub mrgn-btm-20 pdng-0">
            ...
            <div class="content-area-sub">
                ...
                <div class="col-sm-12 mrgn-btm-15">
                    <p>4. Does anything make the  Flank Pain worse?</p></div>
        ...
        <div class="btn-wrap"><button type="button" class="btn btn-primary mrgn-lft-15">Submit Question Set</button><button type="button" class="btn btn-primary mrgn-lft-15">Save</button></div>
